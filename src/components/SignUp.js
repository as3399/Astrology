...
export default function SignUpPage() {
  ...
  const [role1, setRole1] = useState("user");
                    ...
                    return (
                      <>
                        ...
                        <div
                          ...
                          class="custom-control custom-radio custom-radio-color custom-control-inline"
                        >
                          <input
                            type="radio"
                          ...
                          <label
                            ...
                            for="customRadio03"
                          >
                            <span style={{ paddingRight: "5rem" }}> User</span>{" "}
                          </label>
                        </div>
                        <div class="custom-control custom-radio custom-radio-color custom-control-inline">
                          ...
                          >
                            {" "}
                            <span class="pr-20"> Astrologer</span>{" "}
                          </label>
                        </div>
                        <form
                        ...
                        >
                          ...
                          <div class="form-group">
                            ...
                            <input
                              name="email"
                              className={
                                (touched.email && errors.email) || fieldErr == 3
                                  ? "form-control mb-0 invalid is-invalid"
                                  : "form-control mb-0"
                              }
            ...
            <div class="sign-in-page-data w-100">
              <div class="sign-in-from w-100 m-auto">
                ...
                <p class="text-center text-dark ">
                  ...
                  {role == "user" ? "User" : "Astro"} panel.
                </p>
                <Formik
                  initialValues={{ email: "", password: "", customRadio: "" }}
                  validationSchema={Yup.object().shape({
                    email: Yup.string()
                      .email("Invalid Email Address")
                      .required("Email Required"),
                  ...
                  onSubmit={async (values) => {
                    console.log(values);
                    await axios
                      .post("http://localhost:5000/astroApi/astrologerLogIn", {
                        email: values.email,
                        password: values.password,
                        role: role
                      })
                  ...
                  {({
                    ...
                    return (
                      <>
                        ...
                        <p class="text-center text-dark">
                          <Link to="/AdminSignin">
                            <a href="#"> SignIn as an Administrator </a>
                          </Link>
                        </p>
                      </>
                    );
